...
from src.adapter.security.secure_file import restrict
...
class _MessageColumns:
    """The stored shape of a message, shared by history and favorites tables."""
...
class SqliteMessageStore(IMessageStore):
    """SQLite-backed message history, mapped with SQLAlchemy."""
