...
# Palette from neural-background.html (:root design tokens).
BG = "#111110"
SURFACE_ALT = "#1a1a18"
SURFACE = "#232320"
ACCENT = "#f0b830"
...
# Content surfaces sit at ~90% opacity so the neural animation behind them is
# muted to a faint glow (90% "blurred") instead of sharp moving dots; the nav
# band and outer margins stay translucent so the animation still reads there.
